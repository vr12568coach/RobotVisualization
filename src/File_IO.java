...
//        System.out.println("Exclude compare = " +exclude+", filename: " + dir.getName() + " equal?: "+ dir.getName().equals(exclude));
...
//                break;
        ...
        /* ITEMS BELOW ARE FOR BasicOpMode IMPORTS AND MEMBERS*/
            ...
            case "//import OfflineCode.Field.FieldConfiguration;":// field configuration
                ...
                break;
            case "       boolean[] configArray = new boolean[]{ true, \ttrue, \ttrue, \t\ttrue, \t\ttrue,\t\ttrue};//Offline needs to disable collector":// HW config Array
...
//                break;
            case "//            shooterLeft = new DcMotor();shooterRight = new DcMotor();shooterLeft.timeStep = om.timeStep;shooterRight.timeStep = om.timeStep;//NEEDED FOR OFFLINE":// SHOOTER
                ...
                break;
            case "//            wobbleGoalServo = new Servo();wobbleGoalArm = new DcMotor();wobbleGoalArm.timeStep = om.timeStep * (0.2);//NEEDED FOR OFFLINE":// WOBBLE GOAL ARM
